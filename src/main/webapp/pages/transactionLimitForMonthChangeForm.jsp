...
<div class="mainSeparateForm" style="margin-bottom:50px;padding-left:80px;padding-right:80px;">
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="col-lg-12" style="font-size:36px;font-weight:bold;color:black;margin-top:50px;text-align:center;">Change transaction limits for month</div>
                <div class="form-group" style="margin-top:50px;margin-left:10px;">
                    <label>Actual limit: ${loggedUser.getLimitTransactionForMonth()}, Day limit: ${loggedUser.getLimitTransactionForDay()}</label>
                </div>
                <div class="form-group" style="margin-top:50px;margin-left:10px;">
                    <label>New limits</label>
                    <form:input path="limitTransactionForMonth" placeholder="0 PLN" type="number" step="1" min="0" max="10000000" class="form-control" style="border:1px solid black;margin-bottom:5px;margin-top:5px;"/>
                    <form:errors path="limitTransactionForMonth" style="color:red;" class="form-text text-muted"/>
                </div>
