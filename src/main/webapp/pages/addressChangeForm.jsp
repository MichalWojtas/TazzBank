...
<div class="mainSeparateForm">
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="col-lg-12 headerFormTemplate">Change address</div>
                <div class="form-group formGroupTopTemplate">
                    <label class="labelFormTemplate">Actual address: ${loggedUser.getAddress()}</label>
                </div>
                <div class="form-group formGroupTopTemplate">
                    <label class="labelFormTemplate">New address</label>
                    <form:input path="address" placeholder="Address" type="text" class="form-control inputControlFormTemplate"/>
                    <form:errors path="address" class="form-text errorTextFormTemplate"/>
                </div>
