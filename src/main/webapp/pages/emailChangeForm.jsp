...
<div class="mainSeparateForm">
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="col-lg-12 headerFormTemplate">Change email</div>
                <div class="form-group formGroupTopTemplate">
                    <label class="labelFormTemplate">Actual email: ${loggedUser.getEmail()}</label>
                </div>
                <div class="form-group formGroupTopTemplate">
                    <label class="labelFormTemplate">New email</label>
                    <form:input path="email" placeholder="Email" type="text" class="form-control inputControlFormTemplate"/>
                    <form:errors path="email" class="form-text errorTextFormTemplate"/>
                </div>
