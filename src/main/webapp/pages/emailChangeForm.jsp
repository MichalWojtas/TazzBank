...
<div class="mainSeparateForm" style="margin-bottom:50px;padding-left:80px;padding-right:80px;">
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="col-lg-12" style="font-size:36px;font-weight:bold;color:black;margin-top:50px;text-align:center;">Change email</div>
                <div class="form-group" style="margin-top:50px;margin-left:10px;">
                    <label>Actual email: ${loggedUser.getEmail()}</label>
                </div>
                <div class="form-group" style="margin-top:50px;margin-left:10px;">
                    <label>New email</label>
                    <form:input path="email" placeholder="Email" type="text" class="form-control" style="border:1px solid black;margin-bottom:5px;margin-top:5px;"/>
