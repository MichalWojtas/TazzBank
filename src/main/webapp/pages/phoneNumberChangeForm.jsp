...
<div class="mainSeparateForm" style="margin-bottom:50px;padding-left:80px;padding-right:80px;">
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="col-lg-12" style="font-size:36px;font-weight:bold;color:black;margin-top:50px;text-align:center;">Change authorization and contact phone number</div>
                <div class="form-group" style="margin-top:50px;margin-left:10px;">
                    <label>Actual authorization and contact phone number: ${loggedUser.getPhoneNumber()}</label>
                </div>
                <div class="form-group" style="margin-top:50px;margin-left:10px;">
                    <label>New authorization and contact phone number</label>
                    <form:input path="phoneNumber" placeholder="Phone number" type="text" class="form-control" style="border:1px solid black;margin-bottom:5px;margin-top:5px;"/>
                ...
                <div class="form-group" style="margin-top:20px;margin-left:10px;">
                    <div style="color:red;">No international prefix</div>
                    <div style="color:red;">9 digits</div>
                </div>
