...
<div class="mainSeparateForm">
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="col-lg-12 headerFormTemplate">Change authorization and contact phone number</div>
                <div class="form-group formGroupTopTemplate">
                    <label class="labelFormTemplate">Actual authorization and contact phone number: ${loggedUser.getPhoneNumber()}</label>
                </div>
                <div class="form-group formGroupTopTemplate">
                    <label class="labelFormTemplate">New authorization and contact phone number</label>
                    <form:input path="phoneNumber" placeholder="Phone number" type="text" class="form-control inputControlFormTemplate"/>
                    <form:errors path="phoneNumber" class="form-text errorTextFormTemplate"/>
                </div>
                ...
                <div class="form-group formGroupMidTemplate">
                    <div class="additionalInformationFormTemplate">No international prefix</div>
                    <div class="additionalInformationFormTemplate">9 digits</div>
                </div>
