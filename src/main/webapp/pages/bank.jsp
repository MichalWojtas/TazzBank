...
<div class="col-lg-12 text-center">
    ...
    <div class="text-under-circleButtons">Accounts<br>${loggedUser.getAllAccountsValue()}PLN</div>
    </div>
    <div class="button-wrapper">
    ...
    <div class="text-under-circleButtons">Savings<br>${loggedUser.getAllAccountsValue()}PLN</div>
    </div>
</div>
<div class = "col-lg-12 text-center">
    <div class="button-wrapper">
