...
<div class="col-lg-12 text-center">
    <div class="button-wrapper">
        <button class="circleButtonsLeft" type="button" data-bs-toggle="dropdown" data-bs-target="#standardAccountsDropdown" data-bs-auto-close="outside">
        ...
        <div class="dropdown-menu" id="standardAccountsDropdown">
            <div class="dropdown-item" style="height:auto;">
                <div class ="container">
                    <div class="row">
                        <div class="lg-col-12 headerFormTemplate" style="margin-top:50px;margin-bottom:50px;">Standard accounts:</div>
                        <fieldset>
                            <div class="container" style="width:100%;">
                                <div class="row">
                                    <c:forEach items="${loggedUserSortedList}" var="accountItem" varStatus="loop">
                                        <c:if test="${accountItem.getAccountType().toString().equals('STANDARD')}">
                                            <div class="col-lg-12 displayAllRightTypeAccounts">
                                                <div>Account name: ${accountItem.getAccountName()}</div>
                                                <a href="#" style="color:red;"><div class="textLabelInsideDisplayAllRightTypeAccounts">Change account name</div></a>
                                                <div>Account number:<br>${accountItem.getAccountNumber()}</div>
                                                <div>Value: ${accountItem.getAccountValue()} PLN</div>
                                                <div>Account type: ${accountItem.getAccountType()}</div>
                                                <a href="#" style="color:red;"><div>Change account type</div></a>
                                            </div>
                                        </c:if>
                                    </c:forEach>
                                </div>
        ...
        <div class="text-under-circleButtons">Accounts<br>${loggedUser.getAllStandardAccountsValue()}PLN</div>
    </div>
    <div class="button-wrapper">
        <button class="circleButtonsRight" type="button" data-bs-toggle="dropdown" data-bs-target="#savingAccountsDropdown" data-bs-auto-close="outside">
        ...
        <div class="dropdown-menu" id="savingAccountsDropdown">
            <div class="dropdown-item" style="height:auto;">
                <div class ="container">
                    <div class="row">
                        <div class="lg-col-12 headerFormTemplate" style="margin-top:50px;margin-bottom:50px;">Saving accounts:</div>
                        <fieldset>
                            <div class="container" style="width:100%;">
                                <div class="row">
                                    <c:set var="checkIsAnyOfCreatedSavingAccountDivs" value="false" />
                                    <c:forEach items="${loggedUserSortedList}" var="accountItem" varStatus="loop">
                                        <c:if test="${accountItem.getAccountType().toString().equals('SAVING')}">
                                            <div class="col-lg-12 displayAllRightTypeAccounts">
                                                <div>Account name: ${accountItem.getAccountName()}</div>
                                                <a href="#" style="color:red;"><div class="textLabelInsideDisplayAllRightTypeAccounts">Change account name</div></a>
                                                <div>Account number:<br>${accountItem.getAccountNumber()}</div>
                                            ...
                                            <c:set var="checkIsAnyOfCreatedSavingAccountDivs" value="true" />
                                        </c:if>
                                    </c:forEach>
                                    <c:if test="${checkIsAnyOfCreatedSavingAccountDivs == false}"><div class="lg-col-12 headerFormTemplate" style="margin-top:50px;margin-bottom:50px;">You dont have any saving account</div></c:if>
                                </div>
                            </div>
                        </fieldset>
                    </div>
        ...
        <div class="text-under-circleButtons">Savings<br>${loggedUser.getAllSavingAccountsValue()}PLN</div>
    </div>
</div>
<div class = "col-lg-12 text-center">
    <div class="button-wrapper">
...
<div class = "col-lg-12 text-center" style="margin-top:15px;">
    <div style="display: inline-block;margin-right:15px;font-size:24px;">I have</div><div style="color:orange;font-size:36px;display: inline-block;">${loggedUser.getAllAccountsValue()}PLN</div>
</div>
</div>
</div>
